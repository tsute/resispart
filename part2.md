...
<h3 style="font-weight:bold;color:navy"> 1. Introduction</h3>[](#1)
...
<h3 style="font-weight:bold;color:navy"> 2. Installation of the R software and packages for analyzing microbiome sequence data </h3>[](#2)
...
<h3 style="font-weight:bold;color:navy"> 3. Basic R operations </h3>[](#3)
